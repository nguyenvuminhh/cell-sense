...
async def send_message(
    ...
    return await chat_service.handle_message(
        request, free_user_quota, user, chat_id
    )
...
async def create_new_chat(
    ...
    return await chat_service.create_chat(user)
...
async def get_latest_chat(
    ...
    return await chat_service.get_latest_chat(user)
...
async def get_chat(
    ...
    return await chat_service.get_chat(chat_id, user)
...
async def get_chat_messages(
    ...
    return await chat_service.get_chat_messages(chat_id, user)
...
async def create_message(
    ...
    return await chat_service.create_message(chat_id, user, message_request)
