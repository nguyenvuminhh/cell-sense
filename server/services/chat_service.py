...
def handle_message(
    ...
    response = llm_service.generate_response(request, template_name=JinjaPromptTemplatesNames.LLM_REQUEST_PROMPT, response_schema=MessageResponse.model_json_schema())
